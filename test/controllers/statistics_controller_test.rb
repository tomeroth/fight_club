...
class StatisticsControllerTest < ActionController::TestCase
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post :create, statistic: { experience: @statistic.experience, fighter_id: @statistic.fighter_id, lost: @statistic.lost, win: @statistic.win }
    end
  ...
  test "should update statistic" do
    patch :update, id: @statistic, statistic: { experience: @statistic.experience, fighter_id: @statistic.fighter_id, lost: @statistic.lost, win: @statistic.win }
    assert_redirected_to statistic_path(assigns(:statistic))
  end
